...
async fn main() {
    ...
    let a = neko_aptos::AptosAddress::parse(
        "0xeb663b681209e7087d681c5d3eed12aaa8e1915e7c87794542c3f96e94b3d3bf").unwrap();
    let pk: [u8;32] = hex::decode("a686f0309ab80312979606cfccc10ea2740147ae6888351488d11c46f08fbf60")
        .unwrap().try_into().unwrap();
    assert_eq!(neko_aptos::AptosAddress::from_public_key(&pk), a, "pubkey matches the account");
    let to = neko_aptos::AptosAddress::parse(
        "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef").unwrap();
    ...
    for (label, payload) in [
        ...
        ("USDT", neko_aptos::tx::transfer_fungible_asset(
            neko_aptos::usdt_metadata(), to, 1_000)),
    ] {
