...
impl SettingRow {
    pub fn label(self) -> &'static str {
        match self {
            ...
            SettingRow::EtherscanKey => neko_i18n::t(neko_i18n::Key::Settings_EtherscanKey),
            SettingRow::TonApiKey => neko_i18n::t(neko_i18n::Key::Settings_TonApiKey),
            ...
            SettingRow::AvalancheRpc => neko_i18n::t(neko_i18n::Key::Settings_AvalancheRpc),
            SettingRow::HyperEvmRpc => neko_i18n::t(neko_i18n::Key::Settings_HyperevmRpc),
            SettingRow::MantleRpc => neko_i18n::t(neko_i18n::Key::Settings_MantleRpc),
